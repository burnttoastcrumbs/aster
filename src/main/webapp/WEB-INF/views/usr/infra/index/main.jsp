...
<body>
				...
				<ul id="main_slide" class="slick">
					<li class="slider_item">
						<figure class="toms_menu_slide_img">
							<a href="#"><img src="/resources/img/bnr_pc_sm (1).jpg"
				...
				<c:otherwise>
					...
					<li onclick="window.open('middle.html')">
						...
						<div class="product_content">
							<p><c:out value="${wb.mainPageTitle}">다낭/호이안 4,5,6일 #바나힐 테마파크 #전신마사지</c:out></p>
							<p><c:out value="${wb.mainPageDetail}">시내 4성 or 해변 5성 호텔</c:out></p>
							<p>
								<span><c:out value="${wb.adult_price}">369,000</c:out></span>원~
							</p>
						</div>
					</li>
				</c:forEach>
					...
					<c:otherwise>
						<c:forEach items="${list2}" var="wp" varStatus="status">
							<li onclick="window.open('middle.html')">
								...
								<div class="product_content">
									<p><c:out value="${wp.mainPageTitle}">오사카 3,4일 #100% 출발 확정 #다양한 일정</c:out></p>
									<p><c:out value="${wp.mainPageDetail}">오사카, 교토, 고베, 나라 등 간사이 핵심관광</c:out></p>
									<p>
										<span><c:out value="${wp.adult_price}">649,900</c:out></span>원~
									</p>
								</div>
							</li>
						</c:forEach>
		...
		<div class="wrap">
			<ul class="product_8">
				...
				<li onclick="window.open('middle.html')">
					...
					<div class="product_content">
						<p><c:out value="${wc.mainPageTitle}">나트랑 에어텔 4,5,6일 #셀렉텀 노아 리조트 #올 인클루시브</c:out></p>
						<p><c:out value="${wc.mainPageDetail}">레이트 체크아웃 / 60분 스파 2회</c:out></p>
						<p>
							<span><c:out value="${wc.adult_price}">699,900</c:out></span>원~
						</p>
					</div>
				</li>
						</c:forEach>
		...
		<div class="wrap">
			...
			<c:otherwise>
				...
				<li onclick="window.open('middle.html')">
					...
					<div class="product_content">
						<p><c:out value="${hp.mainPageTitle}">발칸 2개국 9일 #크로아티아/슬로베니아 #블레드성 레스토랑</c:out></p>
						<p><c:out value="${hp.mainPageDetail}">아드리아해 해변 호텔 숙박 / 전일정 4성호텔</c:out></p>
						<p>
							<span><c:out value="${hp.adult_price}">4,090,000</c:out></span>원~
						</p>
					</div>
				</li>
					</c:forEach>
	...
	<c:otherwise>
		<c:forEach items="${list5}" var="mine" varStatus="status">
				<li onclick="window.open('middle.html')">
					...
					<div class="product_content">
						<p><c:out value="${mine.mainPageTitle}">[4회 한정] 알래스카 6일 #빙하 여행 #대자연의 감동</c:out></p>
						<p><c:out value="${mine.mainPageDetail}">하나투어 단독 앵커리지 직항 대한항공 전세기</c:out></p>
						<p>
							<span><c:out value="${mine.adult_price}">5,290,000</c:out></span>원~
						</p>
					</div>
				</li>
				</c:forEach>
		...
		<c:forEach items="${list6}" var="mt" varStatus="status">
						<li class="cruise_25_con2" onclick="window.open('middle.html')">
							...
							<div class="cruise_25_content">
								<p><c:out value="${mt.mainPageTitle}">나트랑 자유여행 5일 #셀렉텀 노아 리조트 #올인클루시브</c:out></p>
								<p><c:out value="${mt.mainPageDetail}">22시 레이트체크아웃 / 60분 스파 2회</c:out></p>
								<p>
									<c:out value="${mt.adult_price}">699,900</c:out><span>원~</span>
								</p>
							</div>
						</li>
						</c:forEach>
				...
				<div class="wrap">
					...
					<c:otherwise>
						...
						<li class="cruise_25_con2" onclick="window.open('middle.html')">
							...
							alt="">
							<div class="cruise_25_content">
								<p><c:out value="${mj.mainPageTitle}">오사카 3,4일 #가성비추천 #시내호텔</c:out></p>
								<p><c:out value="${mj.mainPageDetail}">합리적 가격으로 즐기는 오사카 핵심여행</c:out></p>
								<p>
									<c:out value="${mj.adult_price}">499,900</c:out><span>원~</span>
								</p>
							</div>
						</li>
						</c:forEach>
				...
				<div class="wrap">
					...
					<c:choose>
						...
						<li class="cruise_25_con2" onclick="window.open('middle.html')">
							...
							alt="">
							<div class="cruise_25_content">
								<p><c:out value="${we.mainPageTitle}">스페인 일주 8,9일 #갓성비여행</c:out></p>
								<p><c:out value="${we.mainPageDetail}">전일정 4성 호텔/바르셀로나 자유시간</c:out></p>
								<p>
									<c:out value="${we.adult_price}">2,699,000</c:out><span>원~</span>
								</p>
							</div>
						</li>
							</c:forEach>
				...
				<div class="wrap">
					...
					<c:choose>
						...
						<li class="cruise_25_con2" onclick="window.open('middle.html')">
							...
							alt="">
							<div class="cruise_25_content">
								<p><c:out value="${wn.mainPageTitle}">시드니일주 5~7일 #베스트셀러 #갓성비</c:out></p>
								<p><c:out value="${wn.mainPageDetail}">블루마운틴 시닉3종 / 포트스티븐스</c:out></p>
								<p>
									<c:out value="${wn.adult_price}">2,949,000</c:out><span>원~</span>
								</p>
							</div>
						</li>
							</c:forEach>
	...
	<c:otherwise>
		<c:forEach items="${list}" var="wb" varStatus="status">
						<li class="cruise_25_con2" onclick="window.open('middle.html')">
							<img
							src="/resources/img/6cc07143-6510-41fe-a65b-c2020f8a70f3.jpg"
							alt="">
							<div class="cruise_25_content">
			...
			<div id="tab1-6" class="tab_content1">
				<div class="wrap">
					<ul class="cruise_25">
						<li class="cruise_25_con2" onclick="window.open('middle.html')">
							<img
							src="/resources/img/bb474d22-29ad-48e3-8571-1fd1c5bc6fe9.jpg"
							alt="">
							<div class="cruise_25_content">
			...
			<div id="tab1-7" class="tab_content1">
				<div class="wrap">
					<ul class="cruise_25">
						<li class="cruise_25_con2" onclick="window.open('middle.html')">
							<img
							src="/resources/img/257ed8e4-8a4d-4071-aeab-93b7268a4d72.jpg"
							alt="">
							<div class="cruise_25_content">
